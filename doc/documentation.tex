...
= -\dfrac{1}{3S}\sum_s \vec r_s [c_{s} \times c_{s+1}]
\end{equation*}

Минус в последнем равенстве возник из-за того, что в комплексе заложена ориентация контура для внешней области (для жидкости), а здесь нам нужна внутренность контура.
...
\begin{equation*}
J_0 = \int r^2 dS = \dfrac{1}{4}\int(\rot([\br e_z \times \br r] r^2) dS = \dfrac{1}{4}\int r^2 ([\br e_z \times \br r] \cdot d \br l) = -\dfrac{1}{4} \sum r^2 \cdot ([\br e_z \times \br r] \cdot \Delta \br l)
\end{equation*}
