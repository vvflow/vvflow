...
Локальный:
$\text{Nu}_\text{loc} = \frac{\text{Re} \cdot \text{Pr}}{\Delta t \Delta l \Delta T} \sum q_i$
Суммирование ведется по частицам, рожденным и умершим на данном отрезке.

Средний:
$\text{Nu}_\text{loc} = \dfrac{\sum \text{Nu}}{\sum \Delta l}$
Суммирование по всем отрезкам

Интегральный:
$\text{Nu}_\text{int} = \sum \text{Nu}$
...
\begin{equation*}
{\br V_d}_\text{heat} = \frac {1}{\text{Pr}}\frac{1}{\text{Re}} \cdot\frac{\br I_2 + \br I_3}{I_1 - I_0}
\end{equation*}
