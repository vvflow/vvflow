...
check_err(function() gen_cylinder{ N=nan } end, "bad argument #1 to 'gen_cylinder' ('N' must be positive)")
check_err(function() gen_cylinder{ N=inf } end, "bad argument #1 to 'gen_cylinder' ('N' must be positive)")
...
check_err(function() gen_cylinder{ dl=nan } end, "bad argument #1 to 'gen_cylinder' ('dl' must be a number)")
