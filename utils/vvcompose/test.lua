...
check_dev(function() return cyl:get_slen() end, 2*math.pi, 1e-4)
check_dev(function() return cyl:get_area() end, math.pi, 1e-4)
check_dev(function() return cyl:get_moi_cofm() end, math.pi/2, 1e-4)
...
check_dev(function() return cyl:get_moi_cofm() end, math.pi/2, 1e-4)
check_dev(function() return cyl:get_moi_axis() end, math.pi/2+cyl:get_area()*5, 1e-4)
cyl = nil
collectgarbage()
...
check_dev(function() return plate:get_slen() end, 2*math.pi+4, 1e-4)
