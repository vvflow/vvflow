...
#
get_filename_component(filename "/home/runner/work/vvflow/vvflow/build_make/libarchive-prefix/src/libarchive-3.4.3.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/vvflow/vvflow/build_make/libarchive-prefix/src/libarchive" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libarchive${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libarchive${i}")
