...
def test_plate(env_plate):
    ...
    check('plate.bg.png', args='--size 720x720 -x -1.5,1.5 -y -1.5,1.5 -BG --colorbox --res-hi 256')
    check('plate.bp.png', args='--size 720x720 -x -1.5,1.5 -y -1.5,1.5 -BP --colorbox --res-hi 256')
